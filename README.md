...
* Functioning
  ...
  * the `visitedAt` time-stamp of the locations is initialised when the environment is constructed, whereas the `Now` time-stamp of the robot is not initialised; in this way at the beginning all the locations are set as urgent
